...
export const SLOT_SPEC: SlotSpec[] = [
  {
    step: 0,
    id: 'entrance_sill',
    question: '현관문 앞에 턱이 있나요? 있다면 신용카드를 세로로 세웠을 때와 비교해 어느 정도인가요?',
    hint: '턱은 문 아래쪽에서 물을 막아주는 낮은 단차입니다. 신용카드 세로 길이는 약 8.5cm입니다.',
    options: [
      { label: '턱이 없어요', value: '없음' },
      { label: '카드보다 낮아요', value: '카드보다낮음' },
      { label: '카드와 비슷해요', value: '카드와비슷' },
      { label: '카드보다 높아요', value: '카드보다높음' },
      UNKNOWN_OPTION,
    ],
    enumValues: ['없음', '카드보다낮음', '카드와비슷', '카드보다높음', UNKNOWN],
    photoAssist: true,
    role: 'surface',
  },
  {
  ...
  },
  {
    step: 3,
    id: 'window_base',
    question: '방 창문의 아래쪽이 바깥 땅바닥과 비교해서 어떤가요?',
    hint: '창문이 땅에 파묻힌 형태라면 물이 가장 먼저 들어오는 곳이 됩니다.',
    options: [
      { label: '땅보다 낮아요', value: '땅보다낮음' },
      { label: '땅과 비슷해요', value: '비슷' },
      { label: '땅보다 높아요', value: '땅보다높음' },
      UNKNOWN_OPTION,
    ],
    enumValues: ['땅보다낮음', '비슷', '땅보다높음', UNKNOWN],
    photoAssist: true,
    role: 'surface',
  },
  {
